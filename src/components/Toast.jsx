...
const Toast = ({ message, type = 'info', onClose, duration = 5000 }) => {
  ...
  return (
    <div
      ...
      className={`flex items-center gap-3 px-4 py-3 rounded-lg border backdrop-blur-md shadow-2xl min-w-[300px] max-w-md animate-in slide-in-from-top-5 ${colors[type]}`}
    >
